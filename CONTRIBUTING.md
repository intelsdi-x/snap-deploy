...
3. [Reporting Security Issues](#reporting-security-issues)
...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-deploy/issues)** and let us know what you are thinking.
...
* Clone the fork to `$GOPATH/src/github.com/intelsdi-x/`:
  ...
  $ git clone https://github.com/intelsdi-x/snap-deploy.git
  ```
...
Have you written a blog post about how you use [Snap](http://github.com/intelsdi-x/snap) ? Send it to us [on Slack](http://slack.snap-telemetry.io)!
